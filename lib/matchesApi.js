...
// id: the other party's id from the confirmed slot (investor_id for a
// founder's view, idea_id for an investor's) — the same "id" field
// /api/founder/status and /api/investor/status already return per slot.
export const completeDeal = (id, token) => post('/complete-deal', token, { id })
